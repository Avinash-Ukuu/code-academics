            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-4">
                        ...
                        {{ Form::text('phone', null, ['class' => 'form-control contact_number','id'=>'numberInput' ,'placeholder' => 'Enter Phone', 'required']) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-4">
                        {{ Form::label('education_level', 'Select Education Level', []) }}<span style="color: red;"> *</span>
                        {{ Form::select('education_level',$educationLevels, null, ['class' => 'form-control select2 education_level','placeholder' => 'Select education_level', 'data-placeholder' => 'Select education_level','required']) }}
                    </div>
                    <div class="form-group col-4">
                        {{ Form::label('course_id', 'Select Course', []) }}<span style="color: red;"> *</span>
                        {{ Form::select('course_id',$courses, null, ['class' => 'form-control select2 course', 'placeholder' => 'Select Course', 'data-placeholder' => 'Select Course','required']) }}
                    </div>
                    <div class="form-group col-4">
                        {{ Form::label('source', 'Select Source', []) }}<span style="color: red;"> *</span>
                        {{ Form::select('source',$sources, null, ['class' => 'form-control select2 sources', 'placeholder' => 'Select Source', 'data-placeholder' => 'Select Source','required']) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-12">
                        {{ Form::label('notes', 'Enter Note', []) }}
                        {{ Form::textArea('notes', null, ['class' => 'form-control','placeholder' => 'Enter Note']) }}
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
