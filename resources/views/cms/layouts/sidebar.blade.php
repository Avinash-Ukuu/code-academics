    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item @if (in_array(Route::currentRouteName(), ['course.index','course.create'])) menu-open @endif">
                    <a href="#" class="nav-link  @if (in_array(Route::currentRouteName(), ['course.index','course.create'])) active @endif">
