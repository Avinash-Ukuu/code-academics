            ...
            <div class="row mb-2">
                <div class="col">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('quiz-subcategory.index') }}">Quiz SubCategory List</a></li>
                        <li class="breadcrumb-item active">Quiz SubCategory Form</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div>
    ...
    <div class="col-12">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Quiz SubCategory Form</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            {{ Form::label('quiz_category_id', 'Select Quiz Category', []) }}<span style="color: red;"> *</span>
                            {{ Form::select('quiz_category_id',$quizCategories, $object->quizCategory->id ?? null, ['class' => 'form-control select2','placeholder' => 'Select Quiz Category', 'data-placeholder' => 'Select Quiz Category','required']) }}
                        </div>
                        <div class="form-group col-6">
